from sistema.restaurants import Restaurant
from sistema.menu.drink import Drink
from sistema.menu.dish import Dish

restaurant_square = Restaurant('Square', 'Gourmet')
restaurant_square.to_receive_assessment('Thiago', 5)
